...
const Modal = ({ isOpen, onClose, title, size = 'lg', children, panelClassName = '', bodyClassName = '' }) => {
  if (!isOpen) return null;
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[10vh] px-4">
      <div className="fixed inset-0 bg-black/40" onClick={onClose} />
      <div className={`relative bg-gray-800 rounded-xl shadow-2xl w-full ${sizeMap[size]} max-h-[80vh] flex flex-col animate-fade-in ${panelClassName}`}>

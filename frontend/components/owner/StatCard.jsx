...
const StatCard = ({ icon, label, value, change, changeLabel, color = 'bg-orange-50 text-orange-500' }) => (
    ...
    <div className="flex items-start justify-between mb-3">
      ...
      {change !== undefined && (
        <span className={`inline-flex items-center gap-0.5 text-xs font-semibold px-1.5 py-0.5 rounded-full ${
          change > 0 ? 'text-green-700 bg-green-50' : change < 0 ? 'text-orange-600 bg-orange-50' : 'text-gray-500 bg-gray-50'
        }`}>

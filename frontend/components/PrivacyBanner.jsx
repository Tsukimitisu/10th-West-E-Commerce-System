...
const PrivacyBanner = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[9999] px-4 pb-4 animate-slide-up">
      <div className="max-w-4xl mx-auto bg-gray-800 rounded-2xl shadow-2xl border border-gray-700 p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 leading-relaxed mb-1">
              ...
              <Link to="/privacy" className="text-red-500 hover:underline font-medium">Privacy Policy</Link> and the

...
const OrderTracker = ({ status }) => {
  const steps = [
    { id: 'placed', name: 'Order Placed', icon: ShoppingBag, status: 'pending' },
    { id: 'processing', name: 'Processing', icon: Package, status: 'paid' },
    { id: 'shipped', name: 'Shipped', icon: Truck, status: 'shipped' },
    { id: 'delivered', name: 'Delivered', icon: Check, status: 'completed' },
  ];

...
const AddressDropdowns = ({
  ...
  return (
    <div className="space-y-3">
      <div>
        <label className="block text-sm font-medium text-gray-800 mb-1">{labels.province}</label>
        <select
        ...
        {loadingProvince && <p className="text-xs text-gray-700 mt-1">Loading provinces...</p>}
      </div>

      <div>
        <label className="block text-sm font-medium text-gray-800 mb-1">{labels.city}</label>
        <select
        ...
        {loadingCity && <p className="text-xs text-gray-700 mt-1">Loading cities/municipalities...</p>}
      </div>

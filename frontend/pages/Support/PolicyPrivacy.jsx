      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-gray-800 rounded-2xl border border-gray-700 shadow-sm p-8 md:p-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="font-display font-bold text-2xl text-white">Privacy Policy</h1>
          ...
          <div className="prose prose-sm max-w-none text-gray-700 leading-relaxed space-y-6">
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-gray-900"><th className="text-left p-3 border border-gray-700 font-medium">Data Type</th><th className="text-left p-3 border border-gray-700 font-medium">Purpose</th></tr>
              </thead>
              <tbody>
                <tr><td className="p-3 border border-gray-700">Full name</td><td className="p-3 border border-gray-700">Account management, order fulfillment</td></tr>
                <tr><td className="p-3 border border-gray-700">Email address</td><td className="p-3 border border-gray-700">Account verification, communications, order updates</td></tr>
                <tr><td className="p-3 border border-gray-700">Phone number</td><td className="p-3 border border-gray-700">Order updates, delivery coordination</td></tr>
                <tr><td className="p-3 border border-gray-700">Shipping address</td><td className="p-3 border border-gray-700">Delivery of products</td></tr>
                <tr><td className="p-3 border border-gray-700">Payment method (type only)</td><td className="p-3 border border-gray-700">Transaction processing (we do NOT store card numbers)</td></tr>
                <tr><td className="p-3 border border-gray-700">Order history</td><td className="p-3 border border-gray-700">Customer service, returns processing</td></tr>
                <tr><td className="p-3 border border-gray-700">Device info, IP address</td><td className="p-3 border border-gray-700">Security, fraud prevention, analytics</td></tr>
                <tr><td className="p-3 border border-gray-700">Cookies</td><td className="p-3 border border-gray-700">Site functionality, preferences, analytics</td></tr>
              </tbody>
            </table>

            <h2 className="font-display font-semibold text-lg text-white mt-8">3. Legal Basis for Processing</h2>
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">4. Data Retention</h2>
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-gray-900"><th className="text-left p-3 border border-gray-700 font-medium">Data</th><th className="text-left p-3 border border-gray-700 font-medium">Retention Period</th></tr>
              </thead>
              <tbody>
                <tr><td className="p-3 border border-gray-700">Account data (name, email, phone)</td><td className="p-3 border border-gray-700">Active account + 2 years after deletion</td></tr>
                <tr><td className="p-3 border border-gray-700">Transaction records & invoices</td><td className="p-3 border border-gray-700">10 years (BIR requirement)</td></tr>
                <tr><td className="p-3 border border-gray-700">Activity logs</td><td className="p-3 border border-gray-700">5 years</td></tr>
                <tr><td className="p-3 border border-gray-700">Cookies</td><td className="p-3 border border-gray-700">Session or up to 1 year</td></tr>
              </tbody>
            </table>
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">6. Your Rights</h2>
            ...
            <p className="text-sm">
              ...
              <a href="mailto:dpo@10thwestmoto.com" className="text-red-500 font-medium">dpo@10thwestmoto.com</a> or
              use the "Delete My Account" option in your profile settings.
            </p>

            <h2 className="font-display font-semibold text-lg text-white mt-8">7. Data Security</h2>
            <ul className="list-disc pl-6 space-y-1">
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">8. Data Breach Notification</h2>
            <p>
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">9. Cookies</h2>
            <p>
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">10. Children's Privacy</h2>
            <p>
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">12. Contact & Complaints</h2>
            <div className="bg-red-500/10 border border-red-200 rounded-xl p-4 space-y-2 text-sm">
              <p><strong>Data Protection Officer:</strong> <a href="mailto:dpo@10thwestmoto.com" className="text-red-500">dpo@10thwestmoto.com</a></p>
              <p><strong>General Support:</strong> <a href="mailto:support@10thwestmoto.com" className="text-red-500">support@10thwestmoto.com</a></p>
              <p><strong>Phone:</strong> (02) 8888-1234</p>
              <p className="pt-2 border-t border-red-200 text-orange-700">
                You may also file a complaint with the <strong>National Privacy Commission (NPC)</strong> at{' '}
                <a href="https://www.privacy.gov.ph" target="_blank" rel="noopener noreferrer" className="text-red-500 underline">www.privacy.gov.ph</a>.
              </p>
            </div>
          </div>
        </div>

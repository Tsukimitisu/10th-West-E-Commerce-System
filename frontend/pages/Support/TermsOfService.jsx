      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-gray-800 rounded-2xl border border-gray-700 shadow-sm p-8 md:p-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="font-display font-bold text-2xl text-white">Terms of Service</h1>
              <p className="text-sm text-gray-400">Last updated: March 1, 2026</p>
            </div>
          </div>

          <div className="prose prose-sm max-w-none text-gray-300 leading-relaxed space-y-6">
            <p>
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">1. Eligibility</h2>
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">2. Account Registration</h2>
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>By registering, you consent to the collection and processing of your personal data in accordance with our <Link to="/privacy" className="text-red-500">Privacy Policy</Link> and Republic Act No. 10173 (Data Privacy Act).</li>
            </ul>
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">5. Shipping & Delivery</h2>
            <ul className="list-disc pl-6 space-y-1">
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">6. Returns & Refunds</h2>
            <div className="bg-red-500/10 border border-red-200 rounded-xl p-4 text-sm">
              <p className="font-medium text-white mb-2">DTI DAO 21-01 Compliance (7-Day Return Policy)</p>
            ...
            <p>
              For full details, see our <Link to="/return-policy" className="text-red-500">Return & Refund Policy</Link>.
            </p>

            <h2 className="font-display font-semibold text-lg text-white mt-8">7. Warranty</h2>
            <ul className="list-disc pl-6 space-y-1">
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">8. Data Privacy</h2>
            <p>
              Your personal data is processed in accordance with our <Link to="/privacy" className="text-red-500">Privacy Policy</Link> and
              ...
              at <a href="mailto:dpo@10thwestmoto.com" className="text-red-500">dpo@10thwestmoto.com</a>.
            </p>

            <h2 className="font-display font-semibold text-lg text-white mt-8">9. Intellectual Property</h2>
            <p>
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">10. Prohibited Activities</h2>
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">11. Limitation of Liability</h2>
            <p>
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">12. Dispute Resolution</h2>
            <ul className="list-disc pl-6 space-y-1">
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">13. Account Termination</h2>
            <ul className="list-disc pl-6 space-y-1">
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">14. Modifications</h2>
            <p>
            ...
            <h2 className="font-display font-semibold text-lg text-white mt-8">15. Contact Information</h2>
            <div className="bg-red-500/10 border border-red-200 rounded-xl p-4 text-sm space-y-1">
              ...
              <p><strong>Email:</strong> <a href="mailto:support@10thwestmoto.com" className="text-red-500">support@10thwestmoto.com</a></p>

...
const Contact = () => {
  ...
  if (sent) return (
    <div className="max-w-lg mx-auto px-4 py-20 text-center">
      ...
      <p className="text-gray-400 text-sm mb-6">We've received your message and will get back to you within 24 hours.</p>
      <button onClick={() => { setSent(false); setForm({ name: '', email: '', subject: '', message: '', category: 'general' }); }}
        className="text-sm text-red-500 hover:text-orange-600 font-medium">Send another message</button>
    </div>
  );
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      <div className="text-center mb-10">
        <h1 className="font-display font-bold text-2xl text-white mb-2">Contact Us</h1>
        <p className="text-gray-400">Have a question or need help? We're here for you.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={item.label} className="bg-gray-800 rounded-xl border border-gray-700 p-4 flex items-start gap-3">
        ...
        <div className="lg:col-span-2 bg-gray-800 rounded-xl border border-gray-700 p-6">
          <h2 className="font-semibold text-white mb-4 flex items-center gap-2"><MessageSquare size={18} /> Send a Message</h2>

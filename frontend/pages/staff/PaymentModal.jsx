  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto" role="dialog" aria-modal="true">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
        <div className="fixed inset-0 bg-gray-9000 bg-opacity-75 transition-opacity" onClick={onCancel}></div>

        <div className="inline-block align-bottom bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full">
          <div className="bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-xl font-bold text-white">
                Payment Due: ₱{total.toFixed(2)}
              </h3>
              <button onClick={onCancel} className="text-gray-400 hover:text-gray-400">
                <X className="h-6 w-6" />
              </button>
            </div>
            ...
            {!method ? (
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  className="flex flex-col items-center justify-center p-8 border-2 border-gray-700 rounded-2xl hover:border-red-500 hover:bg-red-500/10 transition-all group"
                >
                ...
                <button
                  ...
                  className="flex flex-col items-center justify-center p-8 border-2 border-gray-700 rounded-2xl hover:border-red-500 hover:bg-red-500/10 transition-all group"
                >
                  <CreditCard className="h-12 w-12 text-red-500 mb-4 group-hover:scale-110 transition-transform" />
                  <span className="text-lg font-bold text-white">Card</span>
                </button>
                <button
                  onClick={() => setMethod('gcash')}
                  className="flex flex-col items-center justify-center p-8 border-2 border-gray-700 rounded-2xl hover:border-blue-500 hover:bg-blue-50 transition-all group"
                >
                ...
                <button
                  ...
                  className="flex flex-col items-center justify-center p-8 border-2 border-gray-700 rounded-2xl hover:border-green-500 hover:bg-green-50 transition-all group"
                >
              ...
              <form onSubmit={handleCashSubmit} className="space-y-6">
                <div>
                  ...
                  <div className="relative rounded-md shadow-sm">
                    ...
                    <input
                      ...
                      autoFocus
                      required
                      className="focus:ring-orange-500 focus:border-red-500 block w-full pl-8 pr-12 sm:text-2xl border-gray-700 rounded-xl py-4"
                      placeholder="0.00"
                      value={tendered}
                ...
                <div className="bg-gray-900 p-4 rounded-lg">
                  ...
                  <div className="flex justify-between text-lg font-medium mt-2">
                    ...
                    <span className={`text-xl font-bold ${changeDue >= 0 ? 'text-green-600' : 'text-red-500'}`}>
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    className="flex-1 py-3 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-900"
                  >
                    Back
                  </button>
                  <button
                    ...
                    className="flex-1 py-3 border border-transparent rounded-xl shadow-lg text-sm font-bold text-white bg-red-500/100 hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                  >
              ...
              <div className="text-center py-8">
                {isProcessing ? (
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-lg font-medium text-white">Processing on terminal...</p>
                    <p className="text-sm text-gray-400 mt-2">Please tap, insert, or swipe card.</p>
                  </div>
                ) : cardSuccess ? (
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex space-x-3">
                      ...
                      <button
                        ...
                        className="flex-1 py-3 border border-transparent rounded-xl shadow-lg text-sm font-bold text-white bg-red-500/100 hover:bg-red-600 transition-all"
                      >
                        Charge Card
                      </button>
                    </div>
              ...
              <div className="text-center py-8">
                {isProcessing ? (
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-lg font-medium text-white">Waiting for {method === 'gcash' ? 'GCash' : 'Maya'} confirmation...</p>
                    <p className="text-sm text-gray-400 mt-2">Customer is confirming payment on their phone.</p>
                  </div>
                ) : cardSuccess ? (
                  <div className="flex flex-col items-center animate-bounce-in">
                    <CheckCircle className="h-16 w-16 text-green-500 mb-4" />
                    <p className="text-xl font-bold text-white">{method === 'gcash' ? 'GCash' : 'Maya'} Payment Received!</p>
                  </div>
                ) : (
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        className="focus:ring-orange-500 focus:border-red-500 block w-full text-center text-lg border-gray-700 rounded-xl py-3"

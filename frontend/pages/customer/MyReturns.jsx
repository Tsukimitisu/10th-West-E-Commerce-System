...
const statusConfig = {
  ...
  rejected:  { icon: XCircle, color: 'text-orange-500', bg: 'bg-orange-50 border-orange-200' },
      ...
      <div className="space-y-4">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-12 text-center">
            ...
            <Link to="/orders" className="text-sm text-orange-500 hover:text-orange-600 font-medium">View your orders</Link>
          </div>
        ) : (
          <div className="space-y-3">
            {returns.map((ret) => {

  ...
  return (
    <AccountLayout>
      <div className="space-y-4">
        <h2 className="font-display font-semibold text-lg text-white flex items-center gap-2"><RotateCcw size={20} /> My Returns</h2>
        ...
        {loading ? (
          ...
          <div className="bg-gray-800 rounded-xl border border-gray-700 p-12 text-center">
            ...
            <h3 className="font-semibold text-white mb-1">No returns</h3>
            <p className="text-sm text-gray-400 mb-4">You haven't requested any returns yet.</p>
            <Link to="/orders" className="text-sm text-red-500 hover:text-orange-600 font-medium">View your orders</Link>
          </div>
        ) : (
          <div className="space-y-3">
            {returns.map((ret) => {
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="space-y-1.5 flex-1">
                      <div className="flex items-center gap-3 flex-wrap">
                        <p className="font-semibold text-white text-sm">Return #{ret.id}</p>
                      ...
                      <p className="text-xs text-gray-400 flex items-center gap-1"><Calendar size={12} /> {date}</p>

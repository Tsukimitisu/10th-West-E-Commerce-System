    ...
    <div className="min-h-screen bg-[#0b1220] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-400 mt-1">Sign in to your 10th West Moto account</p>
        </div>

        <div className="bg-gradient-to-b from-[#1a1d23] to-[#111318] rounded-2xl border border-white/10 shadow-2xl p-8">
        <div className="bg-gray-800 rounded-2xl border border-gray-700 shadow-sm p-8">
          ...
          {error && (
            <div className="mb-4 p-3 bg-red-500/10 border border-red-500/30 rounded-lg text-sm text-red-300 flex flex-col gap-2">
          ...
          {resendSuccess && (
            <div className="mb-4 p-3 bg-green-500/10 border border-green-500/30 rounded-lg text-sm text-green-300 flex items-center gap-2">
          ...
          {!needs2FA ? (
            <>
              ...
              <div className="space-y-2 mb-6">
                <button onClick={() => handleOAuth('google')} className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-white/10 rounded-lg hover:bg-[#202430]/80 transition-colors text-sm font-medium text-gray-200">
                ...
                <button onClick={() => handleOAuth('facebook')} className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-white/10 rounded-lg hover:bg-[#202430]/80 transition-colors text-sm font-medium text-gray-200">
              ...
              <div className="relative mb-6">
                ...
                <div className="relative flex justify-center text-sm"><span className="px-3 bg-[#151922] text-gray-400">or sign in with email</span></div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="email" value={email} onChange={e => { setEmail(e.target.value); setNeedsVerification(false); setVerificationEmail(''); setResendSuccess(''); }} required placeholder="name@example.com"
                      className="w-full pl-10 pr-4 py-2.5 border border-white/10 bg-[#202430]/70 text-gray-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent" />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type={showPassword ? 'text' : 'password'} value={password} onChange={e => { setPassword(e.target.value); setNeedsVerification(false); setVerificationEmail(''); setResendSuccess(''); }} required placeholder="Enter your password"
                      className="w-full pl-10 pr-10 py-2.5 border border-white/10 bg-[#202430]/70 text-gray-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent" />
                ...
                <button type="submit" disabled={loading}
                  className="w-full py-3 bg-red-500/100 hover:bg-red-600 disabled:bg-gray-700 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2 text-sm">
            ...
            <div className="text-center">
              ...
              <h2 className="font-display font-semibold text-lg text-white mb-1">Two-Factor Authentication</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <input
                  ...
                  className="w-full text-center text-2xl tracking-[0.5em] font-mono px-4 py-3 border border-white/10 bg-[#202430]/70 text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
                />
                <button type="submit" disabled={loading || totpCode.length !== 6}
                  className="w-full py-3 bg-red-500/100 hover:bg-red-600 disabled:bg-gray-700 text-white font-medium rounded-lg transition-colors text-sm">
                  {loading ? 'Verifying...' : 'Verify Code'}
                </button>
                <button type="button" onClick={() => { setNeeds2FA(false); setTotpCode(''); }} className="text-sm text-gray-400 hover:text-white">
                  Back to login
                </button>
              </form>
            </div>

...
const Login = ({ onLogin }) => {
  ...
  return (
    <div className="py-16 md:py-24 bg-white font-sans flex items-center justify-center px-4 py-12  " style={{backgroundImage: 'radial-gradient(circle, #e7e7e7 1px, transparent 1px)', backgroundSize: '20px 20px'}}>
      <div className="w-full max-w-md">
        ...
        <div className="bg-zinc-900 rounded-2xl border border-gray-700 shadow-sm p-8">
          {pageMessage && (
          ...
          {!needs2FA ? (
            <>
              ...
              <div className="space-y-2 mb-6">
                <button onClick={() => handleOAuth('google')} className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-700 rounded-lg hover:bg-gray-900 transition-colors text-sm font-medium text-gray-300">
                ...
                <button onClick={() => handleOAuth('facebook')} className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-700 rounded-lg hover:bg-gray-900 transition-colors text-sm font-medium text-gray-300">
              ...
              <div className="relative mb-6">
                ...
                <div className="relative flex justify-center text-sm"><span className="px-3 bg-gray-800 text-gray-400">or sign in with email</span></div>
              </div>
            ...
            <div className="text-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <input
                  ...
                  className="w-full text-center text-2xl tracking-[0.5em] font-mono px-4 py-3 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
                />

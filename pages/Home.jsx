      ...
      <section className="relative bg-gray-900 overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 py-16 md:py-24 lg:py-32">
          <div className="max-w-xl">
            <span className="inline-flex items-center gap-2 px-3 py-1 bg-red-600/20 border border-red-500/30 rounded-full text-red-400 text-xs font-semibold mb-4">
            ...
            <h1 className="font-display font-bold text-3xl md:text-5xl lg:text-6xl text-white mb-4 leading-tight">
              Ride With <span className="text-red-500">Confidence</span>
            </h1>
            <p className="text-gray-400 text-sm md:text-base mb-8 max-w-md leading-relaxed">
              Quality motorcycle parts, accessories, and gear from trusted brands. Free shipping on orders over â‚±2,500.
            </p>
            <div className="flex flex-wrap gap-3">
              <Link to="/shop" className="px-6 py-3 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-all hover:shadow-lg hover:shadow-red-600/20 flex items-center gap-2">
        ...
        <section className="py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex items-center justify-between mb-8">
              ...
              <Link to="/shop" className="text-sm text-red-600 hover:text-red-700 font-medium flex items-center gap-1">
                View All <ArrowRight size={14} />
              </Link>
            </div>
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-3">
              {categories.slice(0, 8).map(cat => (
                <Link key={cat.id} to={`/shop?category=${cat.id}`} className="group flex flex-col items-center gap-2 p-4 bg-gray-50 hover:bg-red-50 rounded-xl transition-colors text-center">
                  <div className="w-12 h-12 bg-white group-hover:bg-red-100 rounded-lg flex items-center justify-center transition-colors shadow-sm">
                    <span className="text-lg font-bold text-gray-400 group-hover:text-red-600 transition-colors">{cat.name.charAt(0)}</span>
                  </div>
                  <span className="text-xs font-medium text-gray-700 group-hover:text-red-600 transition-colors line-clamp-2">{cat.name}</span>
                </Link>
              ))}
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <span className="text-red-400 text-sm font-semibold">Limited Time Offer</span>
            ...
            <Link to="/shop?sale=true" className="relative z-10 px-8 py-3 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-colors shrink-0 flex items-center gap-2">
        ...
        <section className="py-12 md:py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex items-center justify-between mb-8">
              ...
              <Link to="/shop?sort=best-selling" className="text-sm text-red-600 hover:text-red-700 font-medium flex items-center gap-1">
                View All <ArrowRight size={14} />
              </Link>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <section className="py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex items-center justify-between mb-8">
              ...
              <Link to="/shop?sort=newest" className="text-sm text-red-600 hover:text-red-700 font-medium flex items-center gap-1">
                View All <ArrowRight size={14} />
              </Link>
            </div>

    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-1 bg-white rounded-lg border border-gray-100 p-1 w-fit">
        {[
          ...
          <button key={t.id} onClick={() => setTabt.id} className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium transition-all ${tab === t.id ? 'bg-red-50 text-red-600' : 'text-gray-500 hover:text-gray-700'}`}>

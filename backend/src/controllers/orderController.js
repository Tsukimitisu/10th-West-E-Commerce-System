...
const VAT_RATE = 0.12;
const FREE_STANDARD_SHIPPING_THRESHOLD = Number.parseFloat(process.env.FREE_SHIPPING_THRESHOLD || '3000');
...
const mapOrderRecord = (order) => {
  ...
  shipping_coverage: normalizeText(order.shipping_coverage) || 'luzon_only',
  base_shipping_fee: roundMoney(order.base_shipping_fee || 0),
  weight_surcharge: roundMoney(order.weight_surcharge || 0),
  distance_surcharge: roundMoney(order.distance_surcharge || 0),
  actual_weight_kg: roundMoney(order.actual_weight_kg || 0),
  estimated_distance_km: roundMoney(order.estimated_distance_km || 0),
  distance_class: normalizeText(order.distance_class),
  package_class: normalizeText(order.package_class),
